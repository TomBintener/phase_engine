...
#[pyfunction]
fn synthesize_cnot_matrix_64(matrix: Vec<u64>, num_qubits: usize) -> PyResult<Vec<(usize, usize)>> {
    egglog::engine::engine_64::synthesize_cnot_matrix(matrix, num_qubits)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e))
}

#[pyfunction]
fn synthesize_cnot_matrix_128(matrix: Vec<u128>, num_qubits: usize) -> PyResult<Vec<(usize, usize)>> {
    egglog::engine::engine_128::synthesize_cnot_matrix(matrix, num_qubits)
        .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e))
}
